 ...
 * JTA {@link UserTransaction} and {@link TransactionManager} from the Infra-configured
 * {@link JtaTransactionManager} implementation.
 *
 * @author Josh Long
 * @author Phillip Webb
 * @author <a href="https://github.com/TAKETODAY">Harry Yang</a>
 * @since 4.0 2022/10/31 11:12
 */
public class HibernateJtaPlatform extends AbstractJtaPlatform {
  ...
  public HibernateJtaPlatform(JtaTransactionManager transactionManager) {
