...
import infra.orm.ObjectOptimisticLockingFailureException;
import infra.orm.ObjectRetrievalFailureException;
 ...
 * access implementation style in Framework applications, we strongly recommend the use
 ...
 * versions. In terms of binary compatibility, Framework ships a variant for each major
...
public interface HibernateOperations {
   ...
   * registering Framework's {@code IdTransferringMergeEventListener} if
   ...
   * <p>Note that {@code merge} will <i>not</i> update the identifiers
   * in the passed-in object graph (in contrast to TopLink)! Consider
   * registering Framework's {@code IdTransferringMergeEventListener}
