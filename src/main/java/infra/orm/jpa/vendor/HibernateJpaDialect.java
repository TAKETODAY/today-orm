...
import infra.orm.jpa.DefaultJpaDialect;
import infra.orm.jpa.EntityManagerFactoryUtils;
import infra.orm.jpa.JpaDialect;
import infra.orm.jpa.JpaSystemException;
...
/**
 * {@link JpaDialect} implementation for Hibernate.
