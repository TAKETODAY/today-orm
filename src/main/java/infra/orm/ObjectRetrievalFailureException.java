...
public class ObjectRetrievalFailureException extends DataRetrievalFailureException {
   ...
   * @param cause the source exception
   */
  public ObjectRetrievalFailureException(@Nullable Class<?> persistentClass, @Nullable Object identifier, String msg, @Nullable Throwable cause) {
    super(msg, cause);
  ...
  public ObjectRetrievalFailureException(String persistentClassName, Object identifier) {
    this(persistentClassName, identifier,
            "Object of class [%s] with identifier [%s]: not found".formatted(persistentClassName, identifier), null);
  }
   ...
   * @param cause the source exception
   */
  public ObjectRetrievalFailureException(@Nullable String persistentClassName, @Nullable Object identifier, String msg, @Nullable Throwable cause) {
    super(msg, cause);
