...
package infra.orm.jpa.hibernate;
...
import infra.orm.jpa.AbstractEntityManagerFactoryIntegrationTests;
import infra.orm.jpa.hibernate.beans.BeanSource;
import infra.orm.jpa.hibernate.beans.MultiplePrototypesInSpringContextTestBean;
import infra.orm.jpa.hibernate.beans.NoDefinitionInSpringContextTestBean;
import infra.orm.jpa.hibernate.beans.SinglePrototypeInSpringContextTestBean;
...
public class HibernateNativeEntityManagerFactorySpringBeanContainerIntegrationTests
  ...
  protected String[] getConfigLocations() {
    return new String[] { "/infra/orm/jpa/hibernate/hibernate-manager-native.xml",
            "/infra/orm/jpa/memdb.xml", "/infra/orm/jpa/inject.xml",
            "/infra/orm/jpa/hibernate/inject-hibernate-spring-bean-container-tests.xml" };
  }
