...
public class PersistenceXmlParsingTests {
  ...
  public void testMetaInfCase() throws Exception {
    ...
    String resource = "/infra/orm/jpa/META-INF/persistence.xml";
  ...
  public void testExample1() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example1.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testExample2() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example2.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testExample3() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example3.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testExample4() throws Exception {
    ...
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example4.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testExample5() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example5.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testExampleComplex() throws Exception {
    ...
    String resource = "/infra/orm/jpa/persistence-complex.xml";
  ...
  public void testExample6() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-example6.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
    assertThat(info.length).isEqualTo(1);
  ...
  public void testInvalidPersistence() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-invalid.xml";
  ...
  public void testNoSchemaPersistence() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-no-schema.xml";
    assertThatExceptionOfType(RuntimeException.class).isThrownBy(() ->
            reader.readPersistenceUnitInfos(resource));
  }
  ...
  public void testPersistenceUnitRootUrl() throws Exception {
    URL url = PersistenceUnitReader.determinePersistenceUnitRootUrl(new ClassPathResource("/infra/orm/jpa/persistence-no-schema.xml"));
  ...
  public void testPersistenceUnitRootUrlWithJar() throws Exception {
    ClassPathResource archive = new ClassPathResource("/infra/orm/jpa/jpa-archive.jar");
  ...
  public void testJpa1ExcludeUnlisted() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-exclude-1.0.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
  ...
  public void testJpa2ExcludeUnlisted() throws Exception {
    PersistenceUnitReader reader = new PersistenceUnitReader(
            new PathMatchingPatternResourceLoader(), new JndiDataSourceLookup());
    String resource = "/infra/orm/jpa/persistence-exclude-2.0.xml";
    PersistenceUnitInfo[] info = reader.readPersistenceUnitInfos(resource);
